...
| 2    | **SRS** — Đặc tả yêu cầu phần mềm _(tài liệu này)_                 | Business Analyst (BA)                   | Chuyển yêu cầu nghiệp vụ thành **yêu cầu kỹ thuật** chi tiết |
| 3    | **Test Cases** — Kịch bản kiểm thử                                 | Tester _(vai trò của bạn)_              | Kiểm tra phần mềm **có đúng yêu cầu không**                  |
